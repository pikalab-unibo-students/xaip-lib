...
def plotData(to_plot, name):
  ...
  #ax1.set_title("Time performances")
  ax1.fill_between(x, (time_y - time_s), (time_y + time_s), color='r', alpha=.1, label ="time standard deviation")
  ax1.set(xlabel="plan length", ylabel="time standard deviation")
  
  ax2.plot(x, mem_y)
  ax2.fill_between(x,(mem_y - mem_s), (mem_y + mem_s), color='b', alpha=.1, label="memory standard deviation")
  ax1.set(xlabel="plan length", ylabel="memory standard deviation")
  #fig.legend()
  ax2.set(xlabel="plan length", ylabel="time standard deviation")
